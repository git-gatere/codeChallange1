function netSalCalc(basicSalary, benefits) {
    ...
    // Declares the above variables
    grossSalary = basicSalary + benefits
    // Calculates gross salary
    if (grossSalary <= 5999) { // Determines total NHIF deductions
        NHIFDeductions = 150
    } else {
        if (grossSalary <= 7999) {
            NHIFDeductions = 300
                                                    ...
                                                    if (grossSalary <= 79999) {
                                                        ...
                                                        if (grossSalary <= 89999) {
                                                            ...
                                                            if (grossSalary <= 99999) {
                                                                ...
                                                                NHIFDeductions = 1700
                                                                // Calculates total NHIF deductions
    ...
    if (grossSalary < 18000) {
        ...
        NSSFDeductions = 2160
        // Calculates total NSSF deductions
    }
...
console.log(netSalCalc(300000,40000));
// this is where you input the salary and the